...
float reverbsnrrev_IIR(float time, float f, float tL, float vel, float IIRgain, float IIRdel1, float IIRdel2, float IIRdel3, float IIRdel4)
{
    ...
    for(int d=0; d<4; d++)
    {
        ...
        {
            float _TIME = time - float(i)*delay[d] * (.8 + .4*pseudorandom(sum));
            sum += fac*.702*(.96*lpnoise(_TIME,2917.065)+.445*lpnoise(_TIME,3381.558)+.851*lpnoise(_TIME,4613.34))*(smoothstep(0.,.01,_TIME)-smoothstep(0.,.974,_TIME-.191)) + _sin(drop_phase(_TIME,.271,2814.579,131.147))*exp(-_TIME*14.303)*.617+ _sin(drop_phase(_TIME*758.218,.271,2814.579,131.147))*exp(-_TIME*21.812)*.848;
            fac *= -IIRgain;
        }
    }
    return .25*sum;
...
vec2 mainSynth(float time)
{
    ...
    for(int trk = 0; trk < NTRK; trk++)
    {
      ...
      +.2*(lpnoise((_t-0.00*(1.+.5*_sin(.127*_t))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-0.00*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-0.00*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-2.40e-02*(1.+.5*_sin(.127*_t))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-2.40e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-2.40e-02*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-4.80e-02*(1.+.5*_sin(.127*_t))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-4.80e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-4.80e-02*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-7.20e-02*(1.+.5*_sin(.127*_t))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-7.20e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-7.20e-02*(1.+.5*_sin(.127*_t)))-.1-0.)));
      ...
      +.2*(lpnoise((_t2-0.00*(1.+.5*_sin(.127*_t2))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-0.00*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-0.00*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-2.40e-02*(1.+.5*_sin(.127*_t2))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-2.40e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-2.40e-02*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-4.80e-02*(1.+.5*_sin(.127*_t2))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-4.80e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-4.80e-02*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-7.20e-02*(1.+.5*_sin(.127*_t2))),(2620.05+(16570.39*(2.*fract(17795.25*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-7.20e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-7.20e-02*(1.+.5*_sin(.127*_t2)))-.1-0.)));
                    }
                    else if(syn == 42){
