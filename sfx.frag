...
float reverbsnrrev_IIR(float time, float f, float tL, float vel, float IIRgain, float IIRdel1, float IIRdel2, float IIRdel3, float IIRdel4)
{
    ...
    for(int d=0; d<4; d++)
    {
        ...
        {
            float _TIME = time - float(i)*delay[d] * (.8 + .4*pseudorandom(sum));
            sum += fac*.935*(.198*lpnoise(_TIME,3229.348)+.399*lpnoise(_TIME,2958.004)+.966*lpnoise(_TIME,3818.105))*(smoothstep(0.,.057,_TIME)-smoothstep(0.,.785,_TIME-.167)) + _sin(drop_phase(_TIME,.13,1404.484,526.858))*exp(-_TIME*32.565)*.137+ _sin(drop_phase(_TIME*537.771,.13,1404.484,526.858))*exp(-_TIME*33.554)*.13;
            fac *= -IIRgain;
        }
    }
    return .25*sum;
...
vec2 mainSynth(float time)
{
    ...
    for(int trk = 0; trk < NTRK; trk++)
    {
      ...
      +_sq_(f*((_t-1.23e-01)-4.50e-02*(1.+1.*_sin(.239*(_t-1.23e-01)))),.5+.09*(.5+(.5*(2.*fract(1533.*Bprog+0.)-1.))))))+.3*(lpnoise((_t-0.00*(1.+.5*_sin(.127*_t))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-0.00*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-0.00*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-2.40e-02*(1.+.5*_sin(.127*_t))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-2.40e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-2.40e-02*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-4.80e-02*(1.+.5*_sin(.127*_t))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-4.80e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-4.80e-02*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-7.20e-02*(1.+.5*_sin(.127*_t))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-7.20e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-7.20e-02*(1.+.5*_sin(.127*_t)))-.1-0.))),.2,.02,.4,.37,.7,.7);
      ...
      +_sq_(f*((_t2-1.23e-01)-4.50e-02*(1.+1.*_sin(.239*(_t2-1.23e-01)))),.5+.09*(.5+(.5*(2.*fract(1533.*Bprog+0.)-1.))))))+.3*(lpnoise((_t2-0.00*(1.+.5*_sin(.127*_t2))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-0.00*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-0.00*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-2.40e-02*(1.+.5*_sin(.127*_t2))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-2.40e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-2.40e-02*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-4.80e-02*(1.+.5*_sin(.127*_t2))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-4.80e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-4.80e-02*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-7.20e-02*(1.+.5*_sin(.127*_t2))),(6202.91+(4286.45*(2.*fract(8021.77*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-7.20e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-7.20e-02*(1.+.5*_sin(.127*_t2)))-.1-0.))),.2,.02,.4,.37,.7,.7);
                    }
                    else if(syn == 42){
