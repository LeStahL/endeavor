...
float reverbsnrrev_IIR(float time, float f, float tL, float vel, float IIRgain, float IIRdel1, float IIRdel2, float IIRdel3, float IIRdel4)
{
    ...
    for(int d=0; d<4; d++)
    {
        ...
        {
            float _TIME = time - float(i)*delay[d] * (.8 + .4*pseudorandom(sum));
            sum += fac*.474*(.558*lpnoise(_TIME,3289.825)+.26*lpnoise(_TIME,2332.415)+.424*lpnoise(_TIME,3872.723))*(smoothstep(0.,.014,_TIME)-smoothstep(0.,.995,_TIME-.25)) + _sin(drop_phase(_TIME,.266,2281.705,786.115))*exp(-_TIME*6.808)*.068+ _sin(drop_phase(_TIME*890.561,.266,2281.705,786.115))*exp(-_TIME*44.6)*.344;
            fac *= -IIRgain;
        }
    }
    return .25*sum;
...
vec2 mainSynth(float time)
{
    ...
    for(int trk = 0; trk < NTRK; trk++)
    {
      ...
      +.2*(lpnoise((_t-0.00*(1.+.5*_sin(.127*_t))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-0.00*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-0.00*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-2.40e-02*(1.+.5*_sin(.127*_t))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-2.40e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-2.40e-02*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-4.80e-02*(1.+.5*_sin(.127*_t))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-4.80e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-4.80e-02*(1.+.5*_sin(.127*_t)))-.1-0.))
      +lpnoise((_t-7.20e-02*(1.+.5*_sin(.127*_t))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t-7.20e-02*(1.+.5*_sin(.127*_t))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t-7.20e-02*(1.+.5*_sin(.127*_t)))-.1-0.)));
      ...
      +.2*(lpnoise((_t2-0.00*(1.+.5*_sin(.127*_t2))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-0.00*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-0.00*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-2.40e-02*(1.+.5*_sin(.127*_t2))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-2.40e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-2.40e-02*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-4.80e-02*(1.+.5*_sin(.127*_t2))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-4.80e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-4.80e-02*(1.+.5*_sin(.127*_t2)))-.1-0.))
      +lpnoise((_t2-7.20e-02*(1.+.5*_sin(.127*_t2))),(4874.16+(12982.95*(2.*fract(1620.39*Bprog+0.)-1.))))*smoothstep(0.,.1,(_t2-7.20e-02*(1.+.5*_sin(.127*_t2))))*(1.-(1.-.05)*smoothstep(0.,.15,(_t2-7.20e-02*(1.+.5*_sin(.127*_t2)))-.1-0.)));
                    }
                    else if(syn == 42){
